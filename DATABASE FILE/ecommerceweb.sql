...
CREATE TABLE `tbl_customer` (
  ...
  `cust_token` varchar(50) NOT NULL,
...
CREATE TABLE `tbl_page` (
  ...
  `about_banner` varchar(50) NOT NULL,
  `about_meta_title` varchar(50) NOT NULL,
  `about_meta_keyword` text NOT NULL,
  `about_meta_description` text NOT NULL,
  `faq_title` varchar(50) NOT NULL,
  `faq_banner` varchar(50) NOT NULL,
  `faq_meta_title` varchar(50) NOT NULL,
  `faq_meta_keyword` text NOT NULL,
  `faq_meta_description` text NOT NULL,
  `blog_title` varchar(50) NOT NULL,
  `blog_banner` varchar(50) NOT NULL,
  `blog_meta_title` varchar(50) NOT NULL,
  `blog_meta_keyword` text NOT NULL,
  `blog_meta_description` text NOT NULL,
  `contact_title` varchar(50) NOT NULL,
  `contact_banner` varchar(50) NOT NULL,
  `contact_meta_title` varchar(50) NOT NULL,
  `contact_meta_keyword` text NOT NULL,
  `contact_meta_description` text NOT NULL,
  `pgallery_title` varchar(50) NOT NULL,
  `pgallery_banner` varchar(50) NOT NULL,
  `pgallery_meta_title` varchar(50) NOT NULL,
  `pgallery_meta_keyword` text NOT NULL,
  `pgallery_meta_description` text NOT NULL,
  `vgallery_title` varchar(50) NOT NULL,
  `vgallery_banner` varchar(50) NOT NULL,
  `vgallery_meta_title` varchar(50) NOT NULL,
...
CREATE TABLE `tbl_settings` (
  ...
  `banner_login` varchar(50) NOT NULL,
  `banner_registration` varchar(50) NOT NULL,
  `banner_forget_password` varchar(50) NOT NULL,
  `banner_reset_password` varchar(50) NOT NULL,
  `banner_search` varchar(50) NOT NULL,
  `banner_cart` varchar(50) NOT NULL,
  `banner_checkout` varchar(50) NOT NULL,
  `banner_product_category` varchar(50) NOT NULL,
  `banner_blog` varchar(50) NOT NULL,
  `cta_title` varchar(50) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` varchar(50) NOT NULL,
  `cta_read_more_url` varchar(50) NOT NULL,
  `cta_photo` varchar(50) NOT NULL,
  `featured_product_title` varchar(50) NOT NULL,
  `featured_product_subtitle` varchar(50) NOT NULL,
  `latest_product_title` varchar(50) NOT NULL,
  `latest_product_subtitle` varchar(50) NOT NULL,
  `popular_product_title` varchar(50) NOT NULL,
  `popular_product_subtitle` varchar(50) NOT NULL,
  `testimonial_title` varchar(50) NOT NULL,
  `testimonial_subtitle` varchar(50) NOT NULL,
  `testimonial_photo` varchar(50) NOT NULL,
  `blog_title` varchar(50) NOT NULL,
  `blog_subtitle` varchar(50) NOT NULL,
  `newsletter_text` text NOT NULL,
  `paypal_email` varchar(50) NOT NULL,
  `stripe_public_key` varchar(50) NOT NULL,
